import svgPaths from "./svg-j1q7p3mpw1";
...
function Paragraph() {
  return (
    <div className="absolute content-stretch flex h-[15.988px] items-start left-0 top-0 w-[80.35px]" data-name="Paragraph">
      <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[#6b7280] text-[12px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Good morning,
      </p>
    </div>
  );
...
function Heading() {
  return (
    <div className="absolute h-[28px] left-0 top-[15.99px] w-[80.35px]" data-name="Heading 1">
      <p className="absolute font-['Open_Sans:Bold',sans-serif] font-bold leading-[28px] left-0 text-[#1a1a1a] text-[18px] top-[-1.4px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Amanda
      </p>
    </div>
  );
...
function Paragraph2() {
  return (
    <div className="absolute h-[40px] left-0 top-[23.99px] w-[298.8px]" data-name="Paragraph">
      <p className="absolute font-['Open_Sans:Bold',sans-serif] font-bold leading-[40px] left-0 text-[36px] text-white top-[-2px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        RM 1010.00
      </p>
    </div>
  );
  ...
  return (
    <div className="h-[15.988px] relative shrink-0 w-[77.05px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Open_Sans:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[12px] text-[rgba(255,255,255,0.9)] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Active pools: 2
        </p>
      </div>
    </div>
...
function Container11() {
  return (
    <div className="absolute content-stretch flex h-[24px] items-center justify-between left-[13px] right-[17px] top-0" data-name="Container">
      <Heading1 />
      <Button3 />
    </div>
  );
...
function Container18() {
  return <div className="h-[6px] rounded-[3px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(178.291248deg, rgb(202, 168, 0) 0%, rgb(253, 220, 0) 100%)" }} data-name="Container" />;
}
...
function Container13() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[12px] h-[93.988px] items-start left-0 pt-[16px] px-[16px] right-0 rounded-[16px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.06)] top-0" data-name="Container">
      <Container14 />
      <Container17 />
    </div>
  );
...
function Container24() {
  return <div className="h-[6px] rounded-[3px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(177.695771deg, rgb(202, 168, 0) 0%, rgb(253, 220, 0) 100%)" }} data-name="Container" />;
}
...
function Container19() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[12px] h-[93.988px] items-start left-0 pt-[16px] px-[16px] right-0 rounded-[16px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.06)] top-[105.99px]" data-name="Container">
      <Container20 />
      <Container23 />
    </div>
  );
...
function Container12() {
  return (
    <div className="absolute h-[200px] left-[13px] top-[36px] w-[370px]" data-name="Container">
      <Container13 />
      <Container19 />
    </div>
  );
...
function Container10() {
  return (
    <div className="absolute h-[236px] left-[15px] top-[373px] w-[400px]" data-name="Container">
      <Container11 />
      <Container12 />
    </div>
  );
...
function Heading4() {
  return (
    <div className="h-[24px] relative shrink-0 w-[148.8px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Open_Sans:Bold',sans-serif] font-bold leading-[24px] left-0 text-[#1a1a1a] text-[16px] top-[-2.2px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          Recent Transactions
        </p>
      </div>
    </div>
...
function Text4() {
  return (
    <div className="absolute h-[15.988px] left-[15px] top-[6.01px] w-[88.65px]" data-name="Text">
      <p className="-translate-x-1/2 absolute font-['Open_Sans:Bold',sans-serif] font-bold leading-[16px] left-[50px] text-[11px] text-center text-white top-0 whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        All Transactions
      </p>
    </div>
  );
...
function Container26() {
  return (
    <div className="absolute content-stretch flex h-[27.988px] items-center justify-between left-[20px] right-[20px] top-0" data-name="Container">
      <Heading4 />
...
function Container28() {
  return (
    <div className="absolute bg-white content-stretch flex h-[64px] items-center justify-between left-0 p-[12px] right-0 rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] top-0" data-name="Container">
      <Container29 />
      <Container34 />
    </div>
  );
...
function Container35() {
  return (
    <div className="absolute bg-white content-stretch flex h-[64px] items-center justify-between left-0 p-[12px] right-0 rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] top-[72px]" data-name="Container">
      <Container36 />
      <Container41 />
    </div>
  );
...
function Container42() {
  return (
    <div className="absolute bg-white content-stretch flex h-[64px] items-center justify-between left-0 p-[12px] right-0 rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] top-[144px]" data-name="Container">
      <Container43 />
      <Container48 />
    </div>
  );
...
function Container49() {
  return (
    <div className="absolute bg-white content-stretch flex h-[64px] items-center justify-between left-0 p-[12px] right-0 rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] top-[216px]" data-name="Container">
      <Container50 />
      <Container55 />
    </div>
  );
...
function Container56() {
  return (
    <div className="absolute bg-white content-stretch flex h-[64px] items-center justify-between left-0 p-[12px] right-0 rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] top-[288px]" data-name="Container">
      <Container57 />
      <Container62 />
    </div>
  );
...
function Container63() {
  return (
    <div className="absolute bg-white h-[64px] left-0 right-0 rounded-[12px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.04)] top-[360px]" data-name="Container">
      <Container64 />
      <Container69 />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[424px] left-[20px] right-[20px] top-[47px]" data-name="Container">
      <Container28 />
      <Container35 />
      <Container42 />
      <Container49 />
...
function Container25() {
  return (
    <div className="absolute h-[484px] left-[8px] top-[650px] w-[407px]" data-name="Container">
      <Container26 />
      <Container27 />
    </div>
  );
...
export default function Homepage() {
  return (
    <div className="bg-gradient-to-b from-[#bedcff] relative size-full to-[#f5f7fa] to-[28.846%]" data-name="homepage">
      <Container />
      <Container10 />
      <Container25 />
      ...
      <Container70 />
      <div className="-translate-y-1/2 absolute h-[44px] left-[-1.16%] right-[1.16%] top-[calc(50%-595.5px)]" data-name="Light">
        <Icons1 />
        <p className="absolute font-['IBM_Plex_Sans:SemiBold',sans-serif] font-semibold leading-[20px] left-[32px] text-[15px] text-black top-[calc(50%-8px)] tracking-[-0.24px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          12:30
        </p>
