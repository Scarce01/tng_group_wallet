import svgPaths from "./svg-ynohrdnjw5";
...
function Container18() {
  return <div className="h-[6px] rounded-[3px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(178.202deg, rgb(202, 168, 0) 0%, rgb(253, 220, 0) 100%)" }} data-name="Container" />;
}
...
function Container24() {
  return <div className="h-[6px] rounded-[3px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(177.53deg, rgb(202, 168, 0) 0%, rgb(253, 220, 0) 100%)" }} data-name="Container" />;
}
...
function Battery() {
  return (
    <div className="absolute contents right-[79.34px] top-[18px]" data-name="Battery">
...
export default function Homepage() {
  return (
    <div className="bg-gradient-to-b from-[#bedcff] relative size-full to-[#fffcf4] to-[28.846%]" data-name="homepage">
      <Container />
      <Container10 />
      <Container25 />
